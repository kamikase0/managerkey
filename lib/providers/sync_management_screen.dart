...
class _SyncManagementScreenState extends State<SyncManagementScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(
                      ...
                      'Es el proceso de enviar los reportes guardados localmente al servidor cuando hay conexión a internet.',
                    ),
                    const SizedBox(height: 12),
                    _buildInfoRow(
                      '🔄 Sincronización Automática',
                      'La aplicación intenta sincronizar automáticamente cada 30 segundos cuando detecta conexión a internet.',
                    ),
                    const SizedBox(height: 12),
                    _buildInfoRow(
                      '💾 Sin Conexión',
                      'Si no hay conexión, los reportes se guardan localmente y se sincronizan cuando la conexión esté disponible.',
                    ),
                    const SizedBox(height: 12),
                    _buildInfoRow(
                      '✅ Estado Sincronizado',
                      'Un ícono de verificación verde en la barra superior indica que todos los reportes están sincronizados.',
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildInfoRow(String titulo, String descripcion) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
