...
class _LoginPageState extends State<LoginPage> {
  ...
  /// ✅ CORRECCIÓN: Navegar al Home - Error arreglado aquí
    ...
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (context) => HomePage(
          onLogout: () {
            // Esta función se ejecutará cuando el usuario haga logout desde HomePage
            print('🔄 Usuario cerró sesión desde HomePage');
            // El HomePage ya maneja la navegación al logout
          },
        ),
      ),
          (route) => false,
