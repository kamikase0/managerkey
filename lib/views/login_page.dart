...
class _LoginPageState extends State<LoginPage> {
  ...
  // ✅ MÉTODO PARA CONSTRUIR EL LOGO CON FALLBACK
  // ✅ MÉTODO PARA CONSTRUIR EL LOGO CON FALLBACK (CORREGIDO)
  // Widget _buildLogo() {
  //   return Container(
  //     height: 80,
  //     width: 80,
  ...
  //     child: ClipOval(
  //       child: Image.asset(
  //         'assets/icono_sereci.png',
  //         fit: BoxFit.cover,
  //         errorBuilder: (context, error, stackTrace) {
  //           // Fallback si la imagen no se puede cargar o no existe
  //           print('⚠️ Error al cargar el logo desde assets: $error'); // Log para depuración
  //           return Container(
  ...
  //           );
  //         },
  //         // El parámetro 'loadingBuilder' fue eliminado porque no es
  //         // compatible con Image.asset y no es necesario para imágenes locales.
  //       ),
  //     ),
  //   );
  // }
